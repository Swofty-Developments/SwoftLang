...
14](/guide/rpg-items) walks the full Hypixel-style pattern, and the
[reference](/reference/items) has every key.
:::
...
That's a kill tracker in ten lines — persistence from [Step 10](/guide/persistence),
optionals from [Step 07](/guide/options), and content from this one. Next: packaging
