...
The base [`Mob`](/1.3.0/reference/events#mob) receiver is the global counterpart to the
...
To *veto* damage, reach for the cancellable [`Entity.on_hit`](/1.3.0/reference/events#entity) —
