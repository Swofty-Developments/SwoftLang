...
tags, and [addons](/1.3.0/libraries/abilities).
...
tutorial](/1.3.0/guide/rpg-items) does. Any other name is rejected, with the fix in the
message:
...
print it. See [lore templating](/1.3.0/guide/rpg-items#lore-templating) for the pattern.
...
[Build an RPG Item System](/1.3.0/guide/rpg-items) tutorial walks the whole pattern, and the
[abilities](/1.3.0/libraries/abilities) addon packages the cooldown machinery in ~50 lines of
SwoftLang.
:::
