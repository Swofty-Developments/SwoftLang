...
powers the narrowing you'll lean on in [Step 07](/1.3.0/guide/options). Reassigning with a
...
| `optional<T>` | `player("Notch")`, `none` | present-or-missing — [Step 07](/1.3.0/guide/options) |
...
([Step 05](/1.3.0/guide/control-flow#loop-over-players)).
...
starts doing serious work in [Step 07](/1.3.0/guide/options). First, the control flow those
branches hang off.
