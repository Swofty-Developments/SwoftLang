...
The whole `Item` — enchantments, custom name, [custom-item](/1.3.0/reference/items) identity —
...
for missing values by hand, which is exactly what [Step 07](/1.3.0/guide/options) abolished.
:::
