...
Every fire — lever, redstone, or `dispense from` — calls the [`Block`](/1.4.0/reference/events#block)
...
[throwable slime example](/1.4.0/examples/throwable-slime) dispenses slime balls as bouncing
