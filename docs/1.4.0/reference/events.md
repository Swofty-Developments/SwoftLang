...
not block a tick, following the usual [async coloring](/1.4.0/guide/async) rules. Cancellation is
...
[`command "..." { }`](/1.4.0/guide/commands) declarations are not events — they define the
