...
Three helpers over the [NBS song statements](/reference/songs), thirty lines in all.
...
`at tick` starts, use the [song statements](/reference/songs#playback-statements)
directly.
