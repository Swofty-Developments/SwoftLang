...
Three helpers over the [NBS song statements](/1.9.0/reference/songs), thirty lines in all.
...
`at tick` starts, use the [song statements](/1.9.0/reference/songs#playback-statements)
directly.
