...
- The **type name** (`CryptGhoul`) is the Capitalized *compile-time* handle. It is a real
  [nominal type](/1.5.0/reference/events#overriding-a-base-receiver) — you write it in
...
The base [`Mob`](/1.5.0/reference/events#mob) receiver is the global counterpart to the
...
To *veto* damage, reach for the cancellable [`Entity.on_hit`](/1.5.0/reference/events#entity) —
