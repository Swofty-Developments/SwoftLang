...
<a class="sw-btn primary" href="/1.2.0/guide/">Start the guide</a>
<a class="sw-btn" href="/1.2.0/guide/commands">Coming from Skript?</a>
<a class="sw-btn" href="/1.2.0/reference/syntax-cheatsheet">Cheatsheet</a>
</div>
</div>
...
philosophy — [the Options guide](/1.2.0/guide/options) is Step 07.
...
<p class="more"><a href="/1.2.0/guide/commands">Skript-to-SwoftLang mappings run through the whole guide →</a></p>
</div>
...
<p class="more"><a href="/1.2.0/guide/properties">Properties guide →</a></p>
</div>
<div class="pillar-code">
...
<p class="more"><a href="/1.2.0/guide/async">Async guide →</a></p>
</div>
<div class="pillar-code">
...
<p class="more"><a href="/1.2.0/reference/gui">GUI reference →</a></p>
</div>
<div class="pillar-code">
...
<p class="more"><a href="/1.2.0/guide/persistence">Persistence guide →</a></p>
</div>
<div class="pillar-code">
...
<a class="sw-btn primary" href="/1.2.0/guide/">Step 01 · Setup</a>
</div>

<p style="margin-top: var(--sp-6)">Or go deeper: <a href="/1.2.0/examples/">full Skript plugins ported line by line</a> and the <a href="/1.2.0/libraries/">standard library addons</a>.</p>
