...
[Persistent variables](/1.2.0/guide/persistence) can be keyed by `Player` or by
...
The seen-store rides whatever [storage backend](/1.2.0/guide/persistence#the-storage-block) you
