...
<a class="sw-hub-card" href="/reference/mob-ai"><span class="sw-hub-body"><span class="sw-hub-title">Mob AI</span><span class="sw-hub-desc">The <code>ai { }</code> block — scripted goals, targets, and the navigator vocabulary.</span></span></a>
