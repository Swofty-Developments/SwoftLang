...
<a class="sw-hub-card" href="/reference/combat"><span class="sw-hub-body"><span class="sw-hub-title">Combat &amp; PvP</span><span class="sw-hub-desc">Build vanilla combat in-language — the enriched <code>EntityDamage</code> event, attribute accessors, <code>apply_damage</code>/<code>apply_knockback</code>/<code>apply_effect</code>/<code>spawn_projectile</code>, and per-entity <code>.tags</code>.</span></span></a>
...
[Libraries](/libraries/), alongside a tutorial on writing your own.
