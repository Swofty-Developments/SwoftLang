...
compile as one unit; [imports](/libraries/) are resolved transitively and the whole
...
ignore it. See [the module system](/libraries/#the-import-system) for resolution
details.
