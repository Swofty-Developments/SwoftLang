...
| Declaration | Purpose |
|---|---|
| `import "name"` / `import "./file.sw"` | Pull in a module ([libraries](/1.8.0/libraries/)) |
| `var name = expr` | Module-level variable, private to the file |
| `export <declaration>` | Make a symbol importable ([libraries](/1.8.0/libraries/#exports)) |
...
| `persistent name: Type = default` | Persistent variable ([guide](/1.8.0/guide/persistence)) |
...
[Functions page](/1.8.0/guide/functions#inline-functions-lambdas).
...
errors, and the addon search path live in the [Libraries section](/1.8.0/libraries/).
