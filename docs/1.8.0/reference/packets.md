...
The first-class [`npc`](/1.8.0/reference/npcs) construct's runtime is built entirely on this
...
[`npc`](/1.8.0/reference/npcs) runtime tells left clicks from right clicks.
...
| fake players / NPCs | the [`npc`](/1.8.0/reference/npcs) construct — first-class — or packets directly |
