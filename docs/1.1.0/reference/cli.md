...
compile as one unit; [imports](/1.1.0/libraries/) are resolved transitively and the whole
...
ignore it. See [the module system](/1.1.0/libraries/#the-import-system) for resolution
details.
